    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Edit Menu Kuliner</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('menu.update', [$place,$menu]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Masukkan Nama Tempat Kuliner" value="{{ old('name') ?? $menu->name }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10"
                            ...
                            value="{{ old('description') }}">{{ old('description') ?? $menu->description }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                            placeholder="Masukkan Harga Tempat Kuliner" value="{{ old('price') ?? $menu->price }}">
